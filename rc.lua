...
beautiful.wallpaper = "/home/unai/.config/awesome/wallpaper.jpg"
...
globalkeys = gears.table.join(
	...
	awful.key({ }, "#232", function () awful.spawn.with_shell("~/Comandos/xbacklight -dec 50") end),
	awful.key({ }, "#233", function () awful.spawn.with_shell("~/Comandos/xbacklight -inc 50") end),
    -- Default
